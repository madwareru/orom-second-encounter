...
pub struct Painter {
    ...
    egui_texture: orom_miniquad::Texture,
}
...
impl Painter {
    pub fn new(ctx: &mut Context) -> Painter {
        ...
        let bindings = Bindings {
            ...
            index_buffer,
            images: vec![orom_miniquad::Texture::empty()],
        };
        ...
        Painter {
            ...
            egui_texture: orom_miniquad::Texture::empty(),
        }
    }
    ...
    fn rebuild_egui_texture(&mut self, ctx: &mut Context, texture: &egui::Texture) {
        ...
        self.egui_texture = orom_miniquad::Texture::from_data_and_format(
            ctx,
            &texture_data,
            orom_miniquad::TextureParams {
                format: orom_miniquad::TextureFormat::RGBA8,
                wrap: orom_miniquad::TextureWrap::Clamp,
                filter: orom_miniquad::FilterMode::Linear,
    ...
    pub fn paint(
        ...
        ctx.begin_default_pass(orom_miniquad::PassAction::Nothing);
    ...
    pub fn paint_job(&mut self, ctx: &mut Context, clip_rect: egui::Rect, mesh: egui::paint::Mesh) {
        ...
        // TODO: support u32 indices in orom_miniquad and just use "mesh.indices" without a need for `split_to_u16`
        ...
        for mesh in meshes {
            ...
            self.bindings.images[0] = match mesh.texture_id {
                ...
                egui::TextureId::User(id) => unsafe { orom_miniquad::Texture::from_raw_id(id as u32) },
            };
...
mod shader {
    use orom_miniquad::{ShaderMeta, UniformBlockLayout, UniformDesc, UniformType};
    ...
    void main() {
        ...
        // orom_miniquad doesn't support linear blending in the framebuffer.
